        ...
        match &assignment.index {
            ...
            Some(e) => {
                ...
                match expressionResult {
                    // TypeValue::Integer(i) => match symbol.size.clone() {
                    //     None => Err(format!("Undeclared variable '{}'.", &assignment.var)),
                    //     Some(size) => {
                    //         if i > &size {
                    //             return Err(format!("Undeclared variable '{}'.", &assignment.var));
                    //         }
                    //     }
                    // },
                    TypeValue::Integer(i) => {
